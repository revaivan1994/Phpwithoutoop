                        ...
                        <div class="col-md-6">
                            <div class="form-group has-danger">
                                ...
                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                    ...
                                    <input type="text" name="name" class="form-control" id="email" placeholder="Title"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-danger">
                                ...
                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                    <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-at"></i></div>
                                    <input type="text" name="phone" class="form-control" id="email" placeholder="Title"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-danger">
                                ...
                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                    <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-at"></i></div>
                                    <textarea name="about" class="form-control" id="text" placeholder="Text" required
                                        autofocus rows="3"><?= $user['about'] ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
